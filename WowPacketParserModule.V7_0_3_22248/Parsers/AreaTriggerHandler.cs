...
namespace WowPacketParserModule.V7_0_3_22248.Parsers
{
    ...
    {
        public static List<AreaTriggerCreatePropertiesSplinePoint> ReadAreaTriggerSpline(WowGuid triggerGuid, Packet packet, params object[] indexes)
        {
        ...
        {
            WowGuid triggerGuid = packet.ReadPackedGuid128("TriggerGUID");
            ReadAreaTriggerSpline(triggerGuid, packet);
        }
        ...
        public static void HandleAreaTriggerReShape(Packet packet)
        {
            ...
            if (hasAreaTriggerSpline)
                ReadAreaTriggerSpline(triggerGuid, packet, "Spline");
