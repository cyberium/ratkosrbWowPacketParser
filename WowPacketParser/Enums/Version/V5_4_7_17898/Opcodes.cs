...
namespace WowPacketParser.Enums.Version.V5_4_7_17898
{
    public static class Opcodes_5_4_7
    {
        ...
        private static readonly BiDictionary<Opcode, int> ClientOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.CMSG_PARTY_INVITE, 0x1990},
            {Opcode.CMSG_PARTY_INVITE_RESPONSE, 0x1C51},
            {Opcode.CMSG_CONVERT_RAID, 0x19A0},
            {Opcode.CMSG_GROUP_REQUEST_JOIN_UPDATES, 0x1792},
            {Opcode.CMSG_SET_PARTY_LEADER, 0x1383},
            {Opcode.CMSG_GROUP_SET_ROLES, 0x1C93},
            {Opcode.CMSG_GROUP_SWAP_SUB_GROUP, 0x1D80},
            {Opcode.CMSG_GROUP_UNINVITE_GUID, 0x0989},
            {Opcode.CMSG_ACCEPT_GUILD_INVITE, 0x18A3},
            ...
            {Opcode.CMSG_PLAYER_SHOWING_CLOAK, 0x1276},
            {Opcode.CMSG_PLAYER_SHOWING_HELM, 0x117F},
        ...
        private static readonly BiDictionary<Opcode, int> ServerOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.SMSG_PARTY_INVITE, 0x1472},
