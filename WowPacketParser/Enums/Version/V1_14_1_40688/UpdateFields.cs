namespace WowPacketParser.Enums.Version.V1_14_1_40688
{
    ...
    public enum PlayerField
    {
        ...
        PLAYER_FIELD_CUSTOMIZATION_CHOICES                                = UnitField.UNIT_END + 0x01D8,      // Size: 70, Flags: (PUBLIC)
    ...
    public enum CorpseField
    {
        ...
        CORPSE_FIELD_CUSTOMIZATION_CHOICES                          = ObjectField.OBJECT_END + 0x0024,      // Size: 70, Flags: (PUBLIC)
        CORPSE_END                                                  = ObjectField.OBJECT_END + 0x006A,
    }
