...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed class PlayerChoiceTemplate : IDataModel
    {
        ...
        [DBFieldName("CloseSoundKitId", TargetedDbExpansion.Shadowlands)]
        public uint? CloseSoundKitId;

        [DBFieldName("Duration", TargetedDbExpansion.Shadowlands)]
        public long? Duration;

        [DBFieldName("Question")]
        public string Question;

        [DBFieldName("PendingChoiceText", TargetedDbExpansion.Shadowlands)]
    ...
    public sealed class PlayerChoiceResponseTemplate : IDataModel
    {
        ...
        [DBFieldName("ResponseIdentifier", TargetedDbExpansion.Shadowlands)]
        ...
        [DBFieldName("UiTextureKitID", TargetedDbExpansion.Shadowlands)]
