...
{
    [DBTableName("areatrigger_create_properties")]
    public sealed class AreaTriggerCreateProperties : WoWObject, IDataModel
    {
        ...
        [DBFieldName("Id", TargetedDbExpansion.Shadowlands, true)]
        ...
        [DBFieldName("Shape", TargetedDbExpansion.Shadowlands)]
        public byte? Shape;

        [DBFieldName("ShapeData", TargetedDbExpansion.Shadowlands, 6, true)]
        ...
        public static uint? GetAreaTriggerCreatePropertiesIdFromSpellId(uint spellId)
        {
            ...
            for (uint idx = 0; idx < 32; idx++)
            {
                ...
                DBC.Structures.BattleForAzeroth.SpellEffectEntry effect;
                if (DBC.DBC.SpellEffectStores.TryGetValue(tuple, out effect))
                {
